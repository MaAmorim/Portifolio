...
const SocialMedia = ()=> {
  return (
    <div className={styles.socialMedia}>
      <a className={styles.link} href="https://www.linkedin.com/in/matheus-amorim-developer/" target="_blank" rel='noopener'>
      ...
      <a className={styles.link} href="" target="_blank" rel='noopener'>
